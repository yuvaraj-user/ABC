...
<div class="row panel panel-primary">
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Add Order Dispatch</div>				
				<div class="col-lg-4 col-md-4 text-right">
					<div class="btn-group text-center">
						<a href="viewemployee.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Order Dispatch</a>
					</div>
				</div>
		</div>
	</div>
		            ...
		            <div class="tab-content">
					  <div class="active tab-pane" id="timeline">
					   ...
					   <div class="col-sm-12 form-group">					   
							...
							<div class="col-sm-4">
								 <input type="text" name="Emp_Code" class="form-control" id="inputName" placeholder="Family No" disabled>
							</div>
                        ...
                        <div class="col-sm-4">
                          <input class="form-control dp"   placeholder="dd-mm-yyyy"  onchange="agecalcualte(this.value)" id="dob_F" name="dob_F" required disabled>
        ...
        $('.datepicker').hide();
			...
			<div class="col-sm-12 form-group">
					  <label for="inputName" class="col-sm-2 control-label">Production No<font color="red">&nbsp;*&nbsp;</font></label>
                        <div class="col-sm-4">
                            <input type="text" name="mobile_F" id="mobile_F" class="form-control"  maxlength="10" pattern=".{10,10}" placeholder="Production No" required disabled>
                        </div>
                        ...
                        <!-- <input type="text" name="designation" class="form-control" id="inputName" placeholder="Designation" >---->
						 <select id="role"  name="role"  class="form-control  selectpicker" data-live-search="true"   disabled>			
					...
					<?php }
					  ...
					  <div class="col-sm-12 form-group">
                        ...
                        <div class="col-sm-4">
                          <input class="form-control dp1"   placeholder="dd-mm-yyyy"  onchange="agecalcualte(this.value)" id="dob_F" name="dob_F" required disabled>
...
<script>
    ...
    $('.dp1').on('change', function () {
        $('.datepicker').hide();
                        ...
                        <div class="col-sm-4">
                          <input type="email" name="email_F" id="email_F" class="form-control" style="text-transform:lowercase" placeholder="Customer Name" disabled>
                        </div>
					  ...
					  <div class="col-sm-12 form-group">
                        ...
                        <div class="col-sm-10">
                          <textarea name="companyname_F" id="companyname_F" placeholder="Present Address" class="form-control" disabled></textarea>
                        </div> 
						</div>
                 ...
                 <div class="form-group col-sm-12">
					  <label for="inputName" class="col-sm-2 control-label">State </label>
                       <div class="col-sm-4">						
						 <select class="form-control selectpicker" name="branchstate" id="branchstate" onChange="getdistrict(this.value);" data-live-search="true" disabled>
...
?>
                      ...
                      <div class="col-sm-12 form-group">
                         ...
                         <div class="col-sm-4">
                         <input type="text" name="reasonresign" class="form-control" id="inputName" placeholder="Contact" disabled>
                         </div>
						...
						<div class="col-sm-12 form-group">
                         ...
                         <div class="col-sm-4">
                         <input type="text" name="reasonresign" class="form-control" id="inputName" placeholder="Quantity" disabled>
                         </div>
						 <label for="inputEmail" class="col-sm-2 control-label">Accessories Details</label>
                        <div class="col-sm-4">
                         <input type="text" name="accholdname" class="form-control" id="inputName" placeholder="Accessories Details" disabled>
                        </div>
                        </div>	
                        ...
                        <div class="col-sm-4">
                         <input type="text" name="bankname" class="form-control" id="inputName" placeholder="Remark" >
                        </div>
                        <label for="inputEmail" class="col-sm-2 control-label">Advance %</label>
                        <div class="col-sm-4">
                         <input type="text" name="bankbranch" class="form-control" id="inputName" placeholder="Advance %" disabled>
                        </div>
                        </div>
						<div class="col-sm-12 form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Estimate</label>
                        <div class="col-sm-4">
                         <input type="text" name="ifsccode" class="form-control" onKeyUp="$(this).val($(this).val().replace(/[`~!@#$%^&*()_|+\-=?;:,.'<>\{\}\[\]\\\/]/gi, ''))" id="inputName" placeholder="Estimate" >
                        </div>
                        			 
                        <label for="inputName" class="col-sm-2 control-label">Projected</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Projected" name="PF_number" id="PF_number" disabled>
                        </div> 
					...
					<label for="inputName" class="col-sm-2 control-label">Balance %</label>
                        <div class="col-sm-4"> 
						  <input type="text" class=" form-control" maxlength="7"  placeholder="Balance %" name="sal_basic" id="sal_basic" disabled> 
						  
                        </div>	
						<label for="inputEmail" class="col-sm-2 control-label">Plan for Dispatch</label>
							<div class="col-sm-4">
								<select id="role"  name="role"  class="form-control  selectpicker" data-live-search="true"   >			
									<option value="">Select Plan for Dispatch</option>
