...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Tax</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_tax.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Tax</a>
				</div>
		</div>
	</div>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select * from tbl_tax where Status='Active'";
			...
			<td><?php echo $fetch['Tax_Price']; ?></td>
			<td><?php echo $fetch['Igst']; ?></td>
			<td><?php echo $fetch['Cgst']; ?></td>
			<td><?php echo $fetch['Sgst']; ?></td>
		     <td> 
		
				<button type="button" onclick="window.location.href='edit_tax.php?id=<?php echo $fetch['Id']; ?>'" class="btn btn-primary">Edit&nbsp;</button>
				
					<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_tax.php?do=delete&id=<?php echo $fetch['Id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
