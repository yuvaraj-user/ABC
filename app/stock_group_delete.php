    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_REQUEST['remark'])) {
                ...
                $query_update_enable = "update `tbl_stock_group` set Remarks='$Remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
                $passquery_update_enable = mysqli_query($con, $query_update_enable);
                if ($passquery_update_enable) {
                    echo '<script type="text/javascript">
					window.location.replace("Stock_group_view.php?step=delete");
					</script>';
                } else {
                    echo '<script type="text/javascript">
            ...
            <div class="row panel panel-primary">
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">Inactive Stock Group</div>
