...
if(isset($_REQUEST['remark']))
{
	...
	$createdby=$_SESSION['usersessionid'];	
								$query_update_enable="update `tbl_sales_return` set Remark='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
      ...
      <div class="col-lg-8 col-md-8">Add Remark Details</div>        
        <div class="col-lg-4 col-md-4 text-right">
          <div class="btn-group text-center">
            ...
            <a href="view_sales_return.php" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Sales Return</a>
          </div>
        </div>
    </div>
  </div>
