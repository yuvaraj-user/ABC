    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_REQUEST['remark'])) {
                ...
                $accessories_status = $_REQUEST['accessories_status'];
                $delay_reason = $_REQUEST['delay_reason'];
                $remark = $_REQUEST['remark'];
              
              
				
				$query_update_order = "update `tbl_order_creation` set machine_dispatch_status='$machine_status',accessories_dispatch_status='$accessories_status' WHERE id='$readid'"; 
                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                       ...
                       <div class="col-sm-12 form-group">
						...
						<label for="inputEmail" class="col-sm-2 control-label">Status</label>
							<div class="col-sm-4">
								<select id="accessories_status"  name="accessories_status"  class="form-control  selectpicker" data-live-search="true"   >			
									<option value="">Select Status</option>
									<option value="1">Yet To Start</option>
