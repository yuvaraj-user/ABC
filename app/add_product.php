...
if(isset($_REQUEST['submit']))
{
	...
	$createdby=$_SESSION['usersessionid'];
			...
			$query_aadh="SELECT COUNT(Id) as cid FROM tbl_product WHERE Name ='$name' AND Status='Active'";
$query_aadh_res = mysqli_query($con, $query_aadh); 
$fetch_cnt = mysqli_fetch_array($query_aadh_res);
 
 if($fetch_cnt['cid'] ==0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_product`(`Name`,`Code`,`Status`) VALUES ('$name','$code','Active')");
		
		if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("view_product.php?step=suces");
					</script>';	
     ...
     echo '<script type="text/javascript">
					window.location.replace("view_product.php?step=duplicate");
					</script>';
}
}
?>
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Add Machine</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="view_product.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Machine</a>
				</div>
			</div>
	</div>
</div>
                ...
                <div class="panel-body"> 
                  <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data" autocomplete="__away">
