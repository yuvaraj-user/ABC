...
if(isset($_REQUEST['remark']))
{
    ...
    $query_update_enable="update `tbl_call_register` set del_Remark='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Call_No='$id'";
        $passquery_update_enable=mysqli_query($con,$query_update_enable);
        if($passquery_update_enable)
        {
            echo '<script type="text/javascript">
                    window.location.replace("View_add.php?step=delete");
                    </script>';										
        } else { 
            echo '<script type="text/javascript">
...
<div class="row panel panel-primary"> 
  <div class="panel-heading lead ">
    <div class="row">
      <div class="col-lg-8 col-md-8">Inactive Call Register</div>        
        <div class="col-lg-4 col-md-4 text-right">
          <div class="btn-group text-center">
            <a href="view_add.php" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Call Register</a>
          </div>
        </div>
    </div>
  </div>
