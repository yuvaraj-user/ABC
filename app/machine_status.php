...
<?php 
    ...
    <strong>Success!</strong> Machine Status is Added Successfully.
  </div>
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> Machine Status is Removed Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Machine Status Report</div>				
...
<br>
					...
					?>
							<tr>
								...
								<td><?php echo $fetch['completed_date'];?></td>
								<td><?php echo $fetch['late_remark'];?></td>
								<td><?php echo $fetch['delay_reason'];?></td>
