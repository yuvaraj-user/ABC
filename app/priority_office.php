...
<?php 
    ...
    <strong>Success!</strong> Order Update is Added Successfully.
  </div>
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Office Priority Report</div>				
	...
	<div class="panel-body"> 
	 <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data" >
		<div class="col-lg-12 col-sm-12"> 
			<label class="control-label col-sm-2">Target Date<font color="red">&nbsp;*&nbsp;</font></label>
					 ...
					 <table id="example1" class="table table-responsive table-bordered table-striped">
						...
						while($fetch=mysqli_fetch_array($qry_receipt))
							...
							<tr>
								...
								<td><button type="button"  class="btn btn-success" onclick="window.location.href='pdn_points_update.php?id=<?php echo $fetch['id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Alter&nbsp;</a></button></td>
					</td>
							</tr>
