...
<?php 
    ...
    <strong>Success!</strong> New State Details Was Added Successfully.
  </div>
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Failed!</strong> This State Was Already Exist.
	</div>
	<?php }
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> This State Details Was Removed Successfully.
	</div>
	<?php } 
	...
	<div class="panel-heading lead ">
			...
			<div class="col-lg-8 col-md-8"><label>View Role Details</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
					...
					<div class="btn-group text-center">
						<a href="add_state.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add State</a>
					</div>
        ...
        <section class="content">
          <div class="row">
			...
			<td><?php echo $fetch['StateName']; ?></td>
			
			
		     <td>
			
			
			<button type="button" onclick="window.location.href='remark_state.php?do=delete&id=<?php echo $fetch['StCode']; ?>'" class="btn btn-danger"> <i class="fa fa-trash" aria-hidden="true"></i> </button>
