...
<?php 
    ...
    <strong>Success!</strong> Purchase are Added Successfully.
  </div>
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> Purchase are Removed Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Purchase</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_purchase.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Purchase</a>
				</div>
		</div>
	</div>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select p.*,s.Name as supplier_name from tbl_purchase p left join tbl_supplier s on p.Supplier_Name=s.Id where p.Status='Active' GROUP BY p.Invoice_No";
			...
			<td><?php echo $fetch['Other_Charges']; ?></td>
			<td><?php echo $fetch['Net_Total']; ?></td>
		     <td>
			
				<ul class="para">
			 <li>
				<button type="submit" class="btn btn-success" data-toggle="modal" name="feedback" data-target="#myModal1<?php echo $i; ?>" data-backdrop="static" data-keyboard="false">View</button> 
				<div class="modal fade" id="myModal1<?php echo $i; ?>" role="dialog">
			<div class="modal-dialog">

				<!-- Modal content-->
				<div class="modal-content"  style="width:90%;margin-left:140px">
					<div class="modal-header custom-stripped">
						<button id="m_close" type="button" class="close" data-dismiss="modal">&times;</button>
						<br>
						<div class="row">
						<div class="col-sm-6">
						<h4 class="modal-title"><b>Date :<?php echo $fetch['Date']; ?></b> </b> </h4>
						</div>
				...
				$pid = $fetch_det['pid'];
					...
					<tr>
						...
						<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_purchase_product.php?do=delete&id=<?php echo $pid; ?>'"><a style=" text-decoration: none; color:#FFF" >Delete</a></button></td>
						</tr>
					<?php 
					$j++;
					}
			  ...
			  <li>
			<button type="button"  class="btn btn-info" onclick="window.location.href='edit_purchase.php?id=<?php echo $pid; ?>'"><a style=" text-decoration: none; color:#FFF" >Edit</a></button>
			  </li>
			   <li>
				<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_purchase.php?do=delete&id=<?php echo $id; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
			</li>
