...
<script>
    ...
    $('.dp1').on('change', function () {
        $('.datepicker').hide();
                        ...
                        <div class="col-sm-4">
                          <input type="email" name="email_F" id="email_F" class="form-control" style="text-transform:lowercase" placeholder="Customer Name" >
                        </div>
                      ...
                      <div class="col-sm-12 form-group">
                        ...
                        <div class="col-sm-4">
                         <input type="text" name="accholdname" class="form-control" id="inputName" placeholder="Machine Code" >
                        </div>
                        </div>	
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Accessories" name="PF_number" id="PF_number">
                        </div> 
						
						<label for="inputName" class="col-sm-2 control-label">Stock</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Stock" name="PF_number" id="PF_number">
                        </div> 
                        </div>
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="PDN Points" name="PF_number" id="PF_number">
                        </div> 
