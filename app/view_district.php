...
<?php 
    ...
    <strong>Success!</strong> District are Added Successfully.
  </div>
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View District</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_district.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add District</a>
				</div>
		</div>
	</div>
          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select * FROM tbl_district where Status='Active'";
			...
			<td><?php echo $fetch['Parent']; ?></td>
		      <td> 
				...
				<button type="button" onclick="window.location.href='edit_district.php?id=<?php echo $fetch['Id']; ?>'" class="btn btn-primary">Edit&nbsp;</button>
				
					<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_district.php?do=delete&id=<?php echo $fetch['Id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Delete&nbsp;</a></button>
