...
if(isset($_REQUEST['submit']))
{
	 ...
	 $createdby=$_SESSION['usersessionid'];
		...
		$insert_details = mysqli_query($con,"Update `tbl_shop` SET `Name`='$Name', `Address`='$Address', `Mobile_No`='$Mobile_No',`Email_Id`='$Email_Id',`Updated_On`='$createdon',`Updated_By`='$createdby', `Status`='$status',`Group_Id`='$group',`District_Id`='$district',`Website`='$website',`Contact_Person`='$contact_person' WHERE Id='$id1'");
		
		if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("view_shop.php?step=edit");
					</script>';	
		}else{
		 echo '<script type="text/javascript">
					window.location.replace("view_shop.php?step=fail");
					</script>';
	}
}
?>
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Edit Shop</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="view_shop.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Shop</a>
				</div>
			</div>
	</div>
</div>
...
<?php
            $id = $_REQUEST['id'];
            $qury="SELECT * FROM `tbl_shop` WHERE Id='$id' and Status='Active'";
...
?>
	 ...
	 <div class="form-group col-sm-12">
					  ...
					  <div class="form-group col-sm-12">
						 ...
						 <div class="col-sm-4">
							<input type="text" placeholder="Name" id="form-field-1" value="<?php echo $fetch_shop['Name']; ?>" class="form-control limited" name="Name" required>
						</div>
						...
						<div class="form-group col-sm-12">
							...
							<div class="col-sm-4">
							<input type="text" name="Mobile_No" onKeyUp="$(this).val($(this).val().replace(/[a-z`~!@#$%^&*()_|+\=?;.:,'<>\{\}\[\]\\\/]/gi, ''))"  maxlength="10" value="<?php echo $fetch_shop['Mobile_No']; ?>" class="form-control">
						  </div>
						  
						   <label for="inputName" class="col-sm-2 control-label">Website</label>
						 <div class="col-sm-4">
							<input type="text" name="website" value="<?php echo $fetch_shop['Website']; ?>" class="form-control">
						</div>
						</div>
						...
						<div class="form-group col-sm-12">
							...
							<label for="inputName" class="col-sm-2 control-label">Contact Person Name</label>
							<div class="col-sm-4">
							<input type="text" name="contact_person" value="<?php echo $fetch_shop['Contact_Person']; ?>" class="form-control">
						  </div>
						
						 <label for="inputName" class="col-sm-2 control-label">Email Id</label>
						 <div class="col-sm-4">
							<input type="text" name="Email_Id" value="<?php echo $fetch_shop['Email_Id']; ?>" class="form-control" >
						</div>
