...
$selectlevel=mysqli_query($con,"select * from tbl_sales_return where Id='$sessionuserid'");
...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Sales Return</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_sales_return.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Sales Return</a>
				</div>
		</div>
	</div>
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php 
				    $qury="select p.*,s.Name as customer_name from tbl_sales_return p left join tbl_customer s on p.Customer_Id=s.Id where p.Status='Active' GROUP BY p.Invoice_No";
