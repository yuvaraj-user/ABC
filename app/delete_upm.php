...
if(isset($_REQUEST['remark']))
{
	...
	$createdby=$_SESSION['usersessionid'];
								$query_update_enable="update `tbl_uom` set Remark='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("view_upm.php?step=delete");
					</script>';										
									}
									else
									{ 
