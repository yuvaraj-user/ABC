...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Month / Week Details</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
				   
					<div class="btn-group text-center">
						<a href="add_attendance_month.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Month / Week</a>
					</div>
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select * from tbl_month_week where Status='Active'";
