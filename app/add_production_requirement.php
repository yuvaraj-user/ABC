...
<div class="row panel panel-primary">
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Add Production Requirement</div>				
    ...
    $('.dp1').on('change', function () {
        $('.datepicker').hide();
                      ...
                      <div class="col-sm-12 form-group">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Projected" name="PF_number" id="PF_number">
                        </div> 
                        </div>
						
						<div class="col-sm-12 form-group">
							<label for="inputEmail" class="col-sm-2 control-label">Priority</label>
							<div class="col-sm-4">
								<select id="role"  name="role"  class="form-control  selectpicker" data-live-search="true"   >			
