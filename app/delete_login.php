...
if(isset($_REQUEST['remark']))
{
	...
	$createdby=$_SESSION['usersessionid'];			
                                 $query_update_enable="update `tbl_users` set Remark='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
                                
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("viewemployeelogin?step=delete");
					</script>';										
									}
									else
									{ 
								echo '<script type="text/javascript">
					window.location.replace("viewemployeelogin.php?step=fail");
					</script>';		
									}
...
<div class="row panel panel-primary"> 
  <div class="panel-heading lead ">
    <div class="row">
      <div class="col-lg-8 col-md-8">Inactive User Login</div>        
        <div class="col-lg-4 col-md-4 text-right">
          <div class="btn-group text-center">
            <!-- <a href="add_customer.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Customer</a>-->
            <a href="viewemployeelogin.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Users Login</a> 
          </div>
        </div>
    </div>
  </div>
