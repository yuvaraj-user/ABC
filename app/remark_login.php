...
if($readrequest=='delete')
								...
								$query_update_enable="update `tbl_users` set Remark='$remarks',Status='Deleted' WHERE Id='$readid'";
								...
								?>
									...
									<strong>Success !</strong>&nbsp;&nbsp;The Selected Component Has Been Deleted.
									<p>		
		<button type="button" onclick="window.location.href='viewemployeelogin.php'" class="btn btn-warning">View Login(s)</button>
		<button type="button" onclick="window.location.href='addemployeelogin.php'" class="btn btn-warning">Or Add Another Login </button>		
		</p>
									</div>
								<?php
									}
