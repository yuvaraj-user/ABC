...
<div class="row panel panel-primary">
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Add Priority</div>				
                ...
                <form class="form-horizontal" name="addcustomer_details"  id="addauctionform" method="post" enctype="multipart/form-data" >
		            <div class="tab-content">
                      ...
                      <div class="col-sm-12 form-group">
						...
						<label for="inputEmail" class="col-sm-2 control-label">Machine Requirement</label>
                        <div class="col-sm-4">
                         <input type="text" name="accholdname" class="form-control" id="inputName" placeholder="Machine Requirement" >
                        </div>
                        </div>	
						...
						<div class="col-sm-12 form-group">
							 ...
							 <label for="inputName" class="col-sm-2 control-label">Old Stock</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Old Stock" name="PF_number" id="PF_number">
                        </div> 
						
						<label for="inputName" class="col-sm-2 control-label">Production Requirement</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Production Requirement" name="PF_number" id="PF_number">
                        </div> 
                        </div>
						
						<div class="col-sm-12 form-group">
							
							 <label for="inputName" class="col-sm-2 control-label">New Stock</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="New Stock" name="PF_number" id="PF_number">
                        </div> 
						
						<label for="inputName" class="col-sm-2 control-label">Priority</label>
                        <div class="col-sm-4">
                         <input type="text" class="form-control "   placeholder="Priority" name="PF_number" id="PF_number">
                        ...
                        <div class="col-sm-4">
                          <input type="text" class="form-control "   placeholder="Total" name="PF_number" id="PF_number">
                        </div> 
						
						<label for="inputName" class="col-sm-2 control-label">Alloted</label>
                        <div class="col-sm-4">
