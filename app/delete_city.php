    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_REQUEST['Remarks'])) {
                ...
                $query_update_enable = "update `tbl_city` set Remarks='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
                $passquery_update_enable = mysqli_query($con, $query_update_enable);
                if ($passquery_update_enable) {
                    echo '<script type="text/javascript">
					window.location.replace("view_city.php?step=delete");
					</script>';
                } else {
                    echo '<script type="text/javascript">
            ...
            <div class="row panel panel-primary">
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8">Inactive City</div>
                        <div class="col-lg-4 col-md-4 text-right">
                            <div class="btn-group text-center">
                                <a href="view_city.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View City</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form class="form-horizontal" name="addemployee_details" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-5 col-sm-10">
                                <button type="submit" name="Remarks" class="btn btn-primary">Submit</button>
                            </div>
                        </div>
                    </form>
                </div><!-- /.tab-pane -->
