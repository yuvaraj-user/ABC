...
if(isset($_REQUEST['submit']))
{
	...
	$updatedby=$_SESSION['usersessionid'];
		...
		$insert_details = mysqli_query($con,"UPDATE tbl_grn SET Grn_No='$name',Updated_By='$updatedby',Updated_On='$createdon' WHERE id='$id'");
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Edit GRN</b></div>				
...
<?php
            $id = $_REQUEST['id'];
            $qury="SELECT * FROM `tbl_grn` WHERE Id='$id' and Status='Active'";
                ...
                <div class="panel-body"> 
                    ...
                    <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data" >
					  ...
					  <div class="form-group col-sm-12">
						 <label for="inputName" class="col-sm-2 control-label">Grn.No<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-4">
							<input type="text" maxlength="150" id="form-field-1"  class="form-control limited" maxlength="15" name="name" 
							value="<?php echo $fetch['Grn_No']; ?>" required>
						</div>
						</div>
