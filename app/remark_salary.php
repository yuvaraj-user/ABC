...
<head>
    ...
    <title><?php echo $filename; ?>| Remark salary</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            if (isset($_REQUEST['remark'])) {
                ...
                $query_update_deleted = "UPDATE `tbl_salary` SET `remark` = '$remarks', `status` ='Deleted' WHERE id = '$id' ";
                $passquery_update_deleted = mysqli_query($con, $query_update_deleted);
                if ($passquery_update_deleted) {
                    echo '<script type="text/javascript">
					window.location.replace("view_salary.php?step=delete");
					</script>';
                } 
            }
            ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-right">
                            <div class="btn-group text-center">
                                <a href="add_salary.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Salary Detail</a>
                                <a href="view_salary.php" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Salary Details</a>
                            </div>
                        </div>
                    </div>
                </div>
