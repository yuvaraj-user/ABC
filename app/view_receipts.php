	...
	<div class="panel-heading lead ">
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select p.*,s.Name as customer_name from tbl_receipts p left join tbl_customer s on p.Customer_Name=s.Id where p.Status='Active' GROUP BY p.Invoice_No_Purchase";
			...
			<td><?php echo $fetch['Payment_Amount']; ?></td>
