...
if(isset($_REQUEST['submit']))
{
	...
	for($i=0;$i<sizeof($product_s);$i++){
		...
		if($quantity_sd!=0){
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_sales_target`(`Customer_Id`, `Start_Date`, `End_Date`, `Product_Id`, `Quantity`, `Sales_Target_No`, `Status`, `Created_By`, `Created_On`) VALUES ('$customer','$start_date','$end_date','$product_sd','$quantity_sd','$sales_target_no','$status','$createdby','$createdon')");		
		}
	}
	...
	if($insert_details){
			 ...
			 echo '<script type="text/javascript">
										window.location.replace("add_sales_target.php?step=suces");
							</script>';		
		 ...
		 echo '<script type="text/javascript">
					window.location.replace("add_sales_target.php?step=fail");
					</script>';
	}
}
?>
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b> Target Fixing for District Co-Ordinators</b></div>				
                ...
                <div class="panel-body"> 
				  ...
				  <div class="row">
	                 <div class="form-group col-sm-4">
	                    <label for="inputName" class="col-sm-4 control-label" >District Co-ordinator<font color="red">&nbsp;*&nbsp;</font></label>
				   ...
				   <script>
					...
					$('.dp').on('change', function () {
                     ...
                     $("#other_charge").val(0);
							...
							<?php 
						    $select_mid=mysqli_query($con,"select MAX(Id) as mid from tbl_sales_target WHERE Status='Active'");
							$fetch_mid=mysqli_fetch_array($select_mid);
							$mid=$fetch_mid['mid'];
							
							$select_inv_no=mysqli_query($con,"select Sales_Target_No from tbl_sales_target WHERE Id='$mid'");
