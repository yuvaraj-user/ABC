...
<?php
                ...
                ?>
                    <div class="alert alert_msg alert-success alert-dismissable">
                        ...
                        <strong>Success!</strong> DC was Added Successfully.
                    </div>
                ...
                ?>
                    <div class="alert alert_msg alert-success alert-dismissable">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                        <strong>Success!</strong> DC was Updated Successfully.
                    </div>
                ...
                <?php } else if ($final == "delete") { ?>
                    <div class="alert alert_msg alert-danger alert-dismissable">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                        <strong>Success!</strong> DC are Removed Successfully.
                    </div>
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">DC Report</div>				
...
<?php
								...
								if(isset($_REQUEST['filter']))
								{
								 ...
								 $to = date("d-m-Y", strtotime($dto));							 
												 ...
												 $query_getall2.="SELECT wo.*,wo.Date as wo_dt,so.*,so.Date as so_dt,l.*,l.Id as ld_id,e.Name as emp_name,t.Name as cus_name,l.Date as ld_dt,p.*,i.*,c.*,t.* FROM tbl_dc wo left join tbl_sales_order so on so.Id=wo.Sale_Order_Id left join  tbl_lead l on so.Lead_Id=l.Id LEFT JOIN tbl_lead_products p on l.Id=p.Lead_Id LEFT JOIN tbl_stock_item i on i.Id=p.Product_Id LEFT JOIN tbl_customer c on c.Id=l.Customer_Id LEFT JOIN tbl_contact_person t on t.Customer_Id=c.Id LEFT JOIN tbl_employee e on l.Followup_Employee=e.Id WHERE wo.Status='Active' AND ";
												$counter=0;
    ...
    $('#example').DataTable( {
			...
			"scrollCollapse": true,
			  "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
			   ...
			   {
					extend: 'copyHtml5',
					title: 'DC Report - <?php echo $bname;?>' 			
				},
				{
					extend: 'pdfHtml5',
					title: 'DC Report - <?php echo $bname;?>' 			
