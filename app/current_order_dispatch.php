...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Current Order Dispatch Report</div>				
					 ...
					 <table id="example1" class="table table-responsive table-bordered table-striped">
						...
						while($fetch=mysqli_fetch_array($qry_receipt))
							...
							<tr>
								...
								<td>
								<button type="button"  class="btn btn-info" onclick="window.location.href='dispatch_plan.php?id=<?php echo $fetch['id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Dispatch&nbsp;</a></button>
