...
$selectlevel=mysqli_query($con,"select * from tbl_purchase_return where Id='$sessionuserid'");
...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Purchase Return</label></div>				
          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php 
				    $qury="select p.*,s.Name as supplier_name from tbl_purchase_return p left join tbl_supplier s on p.Supplier_Id=s.Id where p.Status='Active' GROUP BY p.Invoice_No";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content"  style="width:85%;margin-left:140px">
                    ...
                    <tbody>
					<?php 
				    $qurydelct="select s.*,t.Name as prod_name from tbl_purchase_return s left join tbl_product t on t.Id=s.Product_Id where s.Status='Active' AND s.Invoice_No='$inv_no'";
			  ...
			  <li>
				<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_sales.php?do=delete&id=<?php echo $fetch['Id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
			</li>
			</ul>
