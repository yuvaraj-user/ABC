...
<?php 
    ...
    <strong>Success!</strong> New Month / Week Details Was Added Successfully.
  </div>
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Failed!</strong> This Month / Week Was Already Exist.
	</div>
	<?php }
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> This Month / Week Details Was Removed Successfully.
	</div>
	<?php } 
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> This Month / Week Details Was Updated Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Paid Attendance Details</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
				   
					<div class="btn-group text-center">
						<a href="add_paid_attendance.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Paid attendance</a>
					</div>
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select paid_attendance.*,tbl_employee.Name from paid_attendance left join tbl_employee on tbl_employee.Essl_Id = paid_attendance.employee_id where tbl_employee.on_roll = 'yes'";
