        ...
        <div class="content-wrapper">
            <div class="row panel panel-primary">
                ...
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8"><label>View Remark</label></div>
                        <div class="col-lg-4 col-md-4 text-right">
                            <a href="add_remark.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Remark</a>
                        </div>
                    </div>
                </div>
