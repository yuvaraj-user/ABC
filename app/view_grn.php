...
<?php 
    ...
    <strong>Success!</strong> GRN are Added Successfully.
  </div>
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> GRN are Removed Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View GRN</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_grn.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add GRN</a>
				</div>
		</div>
	</div>
          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select p.*,s.Name as supplier_name from tbl_grn p left join tbl_supplier s on p.Supplier_Name=s.Id where p.Status='Active' GROUP BY p.Invoice_No";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content"  style="width:85%;margin-left:140px">
                    ...
                    <tbody>
					<?php 
				    $qurydelct="select p.*,t.Name as product_name from tbl_grn p left join tbl_product t on p.Product_Id=t.Id where p.Status='Active' AND p.Invoice_No='$inv_no'";
			   ...
			   <li>
				<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_grn.php?do=delete&id=<?php echo $fetch['Invoice_No']; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
			</li>
