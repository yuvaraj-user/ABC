...
if(isset($_REQUEST['submit']))
{
	...
	$createdby=$_SESSION['usersessionid'];
		...
		$insert_details = mysqli_query($con,"UPDATE `tbl_district` SET `Name`='$name', `Parent`='$parent', `Status`='$status', `Updated_On`='$createdon', `Updated_By`='$createdby' WHERE Id='$id'");
		
		if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("view_district.php?step=edit");
					</script>';	
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Edit District</b></div>				
...
<?php
 $id = $_REQUEST['id'];
            $qury="SELECT * FROM `tbl_district` WHERE Id='$id'";
