...
$selectlevel=mysqli_query($con,"select * from tbl_receipts where Id='$sessionuserid'");
...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Receipt</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_receipt.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Receipt</a>
				</div>
		</div>
	</div>
          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select p.*,SUM(p.Payment_Amount) as pay_amt,Name as customer_name from tbl_receipts p left join tbl_customer s on p.Customer_Name=s.Id where p.Status='Active' GROUP BY p.Invoice_No_Purchase";
			...
			<div class="modal-dialog">
				...
				<div class="modal-content"  style="width:85%;margin-left:140px">
                    ...
                    <tbody>
					<?php 
				    $qurydelct="select * from tbl_receipts where Status='Active' AND Invoice_No_Purchase='$inv_no'";
			   ...
			   <li>
				<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_receipts.php?do=delete&id=<?php echo $fetch['Invoice_No']; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
			</li>
