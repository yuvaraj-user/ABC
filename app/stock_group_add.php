...
if (isset($_REQUEST['submit'])) {
    ...
    $query_aadh = "SELECT COUNT(Id) as Id FROM stock_group WHERE  Status='Active'";
    $query_aadh_res = mysqli_query($con, $query_aadh);
    $fetch_cnt = mysqli_fetch_array($query_aadh_res);

    if ($fetch_cnt['Id'] == 0) {

        $insert_details = mysqli_query($con, "INSERT INTO `tbl_stock_group`(`Name`, `Parent`, `Gst_Rate`, `App_Date`, `Igst`, `Gst`, `Sgst`, `Hsn_Code`, `Created_On`, `Created_By`, `Remarks`, `Status`) VALUES ('$Name','$Parent', '$Gst_Rate', '$App_Date', '$Igst', '$Gst', '$Sgst', '$Hsn_Code', '$createdon','$createdby', '$Remarks', 'Active')");

        if ($insert_details) {
            echo '<script type="text/javascript">
					window.location.replace("Stock_group_view.php?step=suces");
					</script>';
        } else {
            echo '<script type="text/javascript">
					window.location.replace("Stock_group_view.php?step=fail");
					</script>';
        }
    } else {
        echo '<script type="text/javascript">
					window.location.replace("Stock_group_view.php?step=duplicate");
					</script>';
    }
}
?>
        ...
        <div class="content-wrapper">
            <div class="row panel panel-primary">
                ...
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8"><b>Add Stock group</b></div>
                        <div class="col-lg-4 col-md-4 text-right">
                            <div class="btn-group text-center">
                                <a href="stock_group_view.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Stock Group</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <!-- <label for="inputName" class="col-sm-2 control-label">App_Date<font color="red">&nbsp;*&nbsp;</font></label>
                        <div class="col-sm-4">
                            <input type="text" placeholder="App Date" maxlength="150" id="form-field-1" class="form-control limited" maxlength="15" name="App_Date" required>
                        </div> -->
						<div class="form-group col-sm-12">
                        <label for="inputName" class="col-sm-2 control-label">Remarks<font color="red">&nbsp;*&nbsp;</font></label>
                        <div class="col-sm-4">
                            <input type="text" placeholder="Remarks" maxlength="150" id="form-field-1" class="form-control limited" maxlength="15" name="Remarks" required>
                        </div>
                        </div>
                        <div class="col-md-12">
						...
						<script>
								$(document).ready(function() {
									...
									$("#other_charge").val(0);
                                                            ...
                                                            <td><input type="text" id="form-field-1" class="form-control limited" name="Gst" style="width:58%;"></td>
                                                            <td><input type="text" id="form-field-1" class="form-control limited" name="Sgst" style="width:58%;"></td>
                                                            <td><input type="text" id="form-field-1" class="form-control limited" name="App_Date" style="width:58%;"></td>
                                                        </tr>
                                                    </thead>
                                                </table>
