...
if(isset($_REQUEST['submit']))
{
    ...
    $cyear=date("y");
		...
		$insert_details = mysqli_query($con,"insert into tbl_area(`City_Id`, `Area`, `Remark`, `Created_On`, `Created_By`, `Updated_On`, `Updated_By`, `Status`)  values('$state','$city','$z_remark','$createdon','$createdby','$updatedon','$updatedby','$status')");
		
		if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("view_area.php?step=suces");
					</script>';	
		 ...
		 echo '<script type="text/javascript">
					window.location.replace("view_area.php?step=fail");
					</script>';
	}
}
	...
	<div class="panel-body"> 
	 <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data" >
	                 ...
	                 <label for="inputName" class="col-sm-2 control-label">City<font color="red">&nbsp;*&nbsp;</font> </label>
                        <div class="col-sm-4">						
						 <select class="form-control selectpicker" name="state" id="state" data-live-search="true" required>
						 <option value="">Select City</option>
						 <?php 
						 $select_GrpQry=mysqli_query($con,"select * from tbl_city");
							while($fetch_GrpQry=mysqli_fetch_array($select_GrpQry))
							{
							$state_name=$fetch_GrpQry['City'];
							$Id=$fetch_GrpQry['Id'];
							?>
					 ...
					 <div id="district-list"> </div>
					  <div class="form-group col-sm-12">
						 <label for="inputName" class="col-sm-2 control-label">Area Name<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-4">
