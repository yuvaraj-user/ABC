...
$selectlevel=mysqli_query($con,"select * from tbl_sales where Id='$sessionuserid'");
...
<?php 
    ...
    <strong>Success!</strong> Sales is Added Successfully.
  </div>
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> Sales is Removed Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Sales</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="add_sales.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Sales</a>
				</div>
		</div>
	</div>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
					...
					<?php 
				    $qury="select p.*,s.Name as customer_name from tbl_sales p left join tbl_customer s on p.Customer_Id=s.Id where p.Status='Active' GROUP BY p.Invoice_No";
			...
			<td><?php echo $fetch['machine_type']; ?></td>
		     <td>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content"  style="width:85%;margin-left:140px">
                    ...
                    <tbody>
					<?php 
				    $qurydelct="select s.*,t.Name as prod_name from tbl_sales s left join tbl_product t on t.Id=s.Product_Id where s.Status='Active' AND s.Invoice_No='$inv_no'";
					...
					<tr>
						...
						<td><?php echo $fetch_det['req_date']; ?></td>
						<td><?php echo $fetch_det['address']; ?></td>
			  ...
			  <li>
				<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_sales.php?do=delete&id=<?php echo $id; ?>'"><a style=" text-decoration: none; color:#FFF" >Inactive&nbsp;</a></button>
			</li>
			</ul>
