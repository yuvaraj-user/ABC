...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Priority List</div>				
...
<?php
									             ...
									             $query_getall2="SELECT * FROM `tbl_order_creation` WHERE Status='Active' and is_factory_view='0'";
...
<form class="form-horizontal" name="addcustomer_details"  id="addauctionform" method="post" enctype="multipart/form-data" >
					...
					?>
							<tr>
								...
								<td><button type="button"  class="btn btn-info" onclick="window.location.href='add_stock.php?id=<?php echo $fetch['id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Add Stock&nbsp;</a></button>
								</td>
							</tr>
