...
<div class="row panel panel-primary">
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Add Plan for Dispatch</div>				
				<div class="col-lg-4 col-md-4 text-right">
					<div class="btn-group text-center">
						<a href="viewemployee.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Dispatch</a>
					</div>
				</div>
		</div>
	</div>
...
<script>
    ...
    $('.dp1').on('change', function () {
        $('.datepicker').hide();
                        ...
                        <div class="col-sm-4">
                          <input type="email" name="email_F" id="email_F" class="form-control" style="text-transform:lowercase" placeholder="Family No" disabled>
                        </div>
					   ...
					   <div class="col-sm-12 form-group">
							<label for="inputEmail" class="col-sm-2 control-label">Production No</label>
							<div class="col-sm-4">
                         ...
                         <label for="inputEmail" class="col-sm-2 control-label">Status</label>
							<div class="col-sm-4">
								<select id="role"  name="role"  class="form-control  selectpicker" data-live-search="true" >			
									...
									<option value="3">In Assembly</option>				
									<option value="4">In QC</option>				
									<option value="5">In Ready</option>				
								</select>
							</div>
						
						<label for="inputEmail" class="col-sm-2 control-label">Accessories Details</label>
                        <div class="col-sm-4">
                         <input type="text" name="accholdname" class="form-control" id="inputName" placeholder="Accessories Details" >
                        </div>
                        </div>	
