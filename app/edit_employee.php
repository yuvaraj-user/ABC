...
if(isset($_REQUEST['submit']))
{
	...
	$group=$_REQUEST['group'];
	 $district=$_REQUEST['district'];
		...
		$insert_details = mysqli_query($con,"UPDATE tbl_employee SET Name='$Name',Address_Line1='$Address_Line1',Address_Line2='$Address_Line2',Address_Line3='$Address_Line3',Address_Line4='$Address_Line4',State='$State',
		Country='$Country',Mobile_No1='$Mobile_No1',Mobile_No2='$Mobile_No2',Email_Id1='$Email_Id1',
		Email_Id2='$Email_Id2',LandLine_No1='$LandLine_No1',LandLine_No2='$LandLine_No2',Updated_By='$updatedby',Updated_On='$createdon',Group_Id='$group',District_Id='$district' WHERE id='$id'");
		
	if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("viewemployee.php?step=edit");
					</script>';	
		}else{
		 echo '<script type="text/javascript">
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Edit User</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="viewemployee.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Users</a>
				</div>
			</div>
	</div>
</div>
...
<?php
            $id = $_REQUEST['id'];
            $qury="SELECT * FROM `tbl_employee` WHERE Id='$id' and Status='Active'";
...
?>
	 ...
	 <div class="form-group col-sm-12">
						 ...
						 <?php 
							...
							?>
							<option value="<?php echo $Id;?>"  <?php if($fetch['Group_Id'] == $Id) echo 'selected';?>><?php echo $Name; ?></option>
						<?php 
							}
						 ?>
						 </select>
					  ...
					  <div class="form-group col-sm-12">
						 ...
						 <div class="col-sm-4">
							...
							<div class="col-sm-4">
							<textarea name="Address_Line1" class="form-control"><?php echo $fetch['Address_Line1']; ?></textarea>
						  </div>
						</div>
						...
						<label for="inputName" class="col-sm-2 control-label">Mobile No</label>
						 <div class="col-sm-4">
							<input type="text" value="<?php echo $fetch['Mobile_No1']; ?>" id="Mobile_No1" class="form-control limited"  name="Mobile_No1" >
						</div>
						
						<label for="inputName" class="col-sm-2 control-label">Email Id</label>
						 <div class="col-sm-4">
							<input type="text" value="<?php echo $fetch['Email_Id1']; ?>" id="Email_Id1" class="form-control limited"  name="Email_Id1" >
						</div>
						</div>
