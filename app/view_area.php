...
<?php 
    ...
    <strong>Success!</strong> New Area Details Was Added Successfully.
  </div>
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Failed!</strong> This Area Was Already Exist.
	</div>
	<?php }
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> This Area Details Was Removed Successfully.
	</div>
	<?php } 
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> This Area Details Was Updated Successfully.
	</div>
	<?php } 
	?>
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Area Details</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
				   
					<div class="btn-group text-center">
						<a href="add_area.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Area</a>
					</div>
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select a.*,c.City as city_name from tbl_area a left join tbl_city c on a.City_Id=c.Id where a.Status='Active'";
			...
			<button type="button" onclick="window.location.href='remark_area.php?do=delete&id=<?php echo $fetch['Id']; ?>'" class="btn btn-danger">Delete&nbsp;</button>
