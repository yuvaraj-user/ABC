...
$fetch_cnt = mysqli_fetch_array($query_aadh_res);
 ...
 if($fetch_cnt['cid'] ==0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_shop`(`Name`, `Address`, `Mobile_No`,`Email_Id`,`Created_On`,`Created_By`, `Status`,`Group_Id`,`District_Id`,`Website`,`Contact_Person`) VALUES ('$Name','$Address','$Mobile_No','$Email_Id','$createdon','$createdby','$status','$group','$district','$website','$contact_person')");
		
		if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("view_shop.php?step=suces");
					</script>';	
		}else{
		 echo '<script type="text/javascript">
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Add Shop</b></div>				
	 ...
	 <div class="form-group col-sm-12">
					  ...
					  <div class="form-group col-sm-12">
						...
						<div class="form-group col-sm-12">
							...
							<div class="col-sm-4">
							<input type="text" name="Mobile_No" onKeyUp="$(this).val($(this).val().replace(/[a-z`~!@#$%^&*()_|+\=?;.:,'<>\{\}\[\]\\\/]/gi, ''))"  maxlength="10" class="form-control">
						  </div>
