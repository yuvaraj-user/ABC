...
if(isset($_REQUEST['submit']))
{
	...
	$sales_target_no = $_REQUEST['sale_target_no'];
	...
	for($i=0;$i<sizeof($product_s);$i++){
		...
		if($quantity_sd!=0){
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_sales_target_shop`(`Shop_Id`, `Start_Date`, `End_Date`, `Product_Id`, `Quantity`, `Sales_Target_No`, `Status`, `Created_By`, `Created_On`) VALUES ('$customer','$start_date','$end_date','$product_sd','$quantity_sd','$sales_target_no','$status','$createdby','$createdon')");		
		}
	}
	...
	if($insert_details){
			 ...
			 echo '<script type="text/javascript">
										window.location.replace("add_sales_shop_target.php?step=suces");
							</script>';		
		 ...
		 echo '<script type="text/javascript">
					window.location.replace("add_sales_shop_target.php?step=fail");
					</script>';
	}
}
?>
...
<?php 
    ...
    <strong>Success!</strong> Target is Added Successfully.
  </div>
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b> Target Fixing for Shops</b></div>				
                ...
                <div class="panel-body"> 
				  ...
				  <div class="row">
	                 <div class="form-group col-sm-4">
	                    <label for="inputName" class="col-sm-4 control-label" >Shops<font color="red">&nbsp;*&nbsp;</font></label>
                        <div class="col-sm-8" style="margin-left: 0px;">						
						 <select class="form-control selectpicker" onchange="get_district(this.value);" name="customer" id="customer" data-live-search="true" required>
						 <option value="">Select Shops</option>
						 
						 <?php 
						    $select_GrpQry=mysqli_query($con,"select * from tbl_shop WHERE Status='Active'");
					 ...
					 <div id="dis_shop"> </div>
							...
							<?php 
						    $select_mid=mysqli_query($con,"select MAX(Id) as mid from tbl_sales_target_shop WHERE Status='Active'");
							$fetch_mid=mysqli_fetch_array($select_mid);
							$mid=$fetch_mid['mid'];
							
							$select_inv_no=mysqli_query($con,"select Sales_Target_No from tbl_sales_target_shop WHERE Id='$mid'");
							$fetch_inv_no=mysqli_fetch_array($select_inv_no);
							$inv_no=$fetch_inv_no['Sales_Target_No'] +1;
						 ...
						 <div class="row">
					 <div class="form-group col-sm-4">
						 <label for="inputName" class="col-sm-4 control-label">Sales Target No<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-8">
							<input type="text" id="sale_order_no"  class="form-control limited" value="<?php echo $inv_no_1; ?>" name="sale_target_no" readonly required>
						</div>
						
						
		</div>
			<div class="form-group col-sm-4">        
                   <label for="inputName" class="col-sm-4 control-label">Start Date<font color="red">&nbsp;*&nbsp;</font></label>
                    <div class="col-sm-8">
						<input class="form-control dp"  value="<?php echo date('d-m-Y').$acctopendate;?>"  placeholder="Pick the Date  dd-mm-yyyy" name="start_date" id="acctopendate" required>
	...
	<div class="form-group col-sm-4">        
                   <label for="inputName" class="col-sm-4 control-label">End Date<font color="red">&nbsp;*&nbsp;</font></label>
                    <div class="col-sm-8">
						<input class="form-control dps" placeholder="Pick the Date  dd-mm-yyyy" name="end_date" id="acctopendate_1" required>
				   ...
				   <div class="form-group col-sm-4">
					  ...
					  <div class="form-group col-sm-4">
						  ...
						  <label for="inputName" class="col-sm-4 control-label">Quantity<font color="red">&nbsp;*&nbsp;</font></label>
						   <div class="col-sm-8" style="margin-left: 0px;">
							<input type="text" maxlength="15" id="quantity" onKeyUp="avail_check(this.value);" class="limited" style="width:80%;" maxlength="15" name="quantity" required>
...
$(document).ready(function(){
     setTimeout(function() { $(".alert_msg").hide(); }, 2000);
}); 
</script>
