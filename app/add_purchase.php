...
if(isset($_REQUEST['submit']))
{
	...
	$supplier_invoice_no = $_REQUEST['supplier_invoice_no'];
	$supplier_date = $_REQUEST['supplier_date'];
	$unit = $_REQUEST['unit'];
	...
	$unit_s = $_REQUEST['unit_s'];
	$ori_quantity_1 = $_REQUEST['ori_quantity_1'];
	...
	for($i=0;$i<sizeof($product_s);$i++){
		...
		$unit_sd = $unit_s[$i];
		$ori_quantity_1d = $ori_quantity_1[$i];
		if($netamount_sd !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase`(`Supplier_Name`, `Date`, `Invoice_No`,`Grn_No`, `Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Supplier_Invoice_No`,`Supplier_Date`,`Unit`,`Original_Quantity`) VALUES ('$supplier','$acctdate','$invoice_no','$grn_no','$product_sd','$quantity_sd','$rate_sd','$amount_sd','$cgst_sd','$sgst_sd','0','$netamount_sd','$total','$discount','$other_charge','$net_total','$createdon','$createdby','$status','$supplier_invoice_no','$supplier_date','$unit_sd','$ori_quantity_1d')");
	}
	}
	if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("report_purchase.php?step=suces");
					</script>';	
		 ...
		 echo '<script type="text/javascript">
					window.location.replace("report_purchase.php?step=fail");
					</script>';
	}
}
?>
    ...
    <head>
		...
		function get_available_quantity(val) {
            ...
            $("#quantity").val('');
				...
				({  
				type: "POST",
				url: "get_available_quantity_1.php",
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Purchase</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="report_purchase.php" class="btn btn-success"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;View Purchase</a>
				</div>
			</div>
	</div>
</div>
				  ...
				  <div class="row">
	                 <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8" style="margin-left: 0px;">						
						 <select class="form-control selectpicker" name="supplier" id="supplier" onchange="get_grn_details(this.value);" data-live-search="true" required>
				...
				<div class="form-group col-sm-4">        
                   <label for="inputName" class="col-sm-4 control-label">Date</label>
                    <div class="col-sm-8">
					   ...
					   <?php 
						    $select_mid=mysqli_query($con,"select MAX(Id) as mid from tbl_purchase WHERE Status='Active'");
							$fetch_mid=mysqli_fetch_array($select_mid);
							$mid=$fetch_mid['mid'];
							
							$select_inv_no=mysqli_query($con,"select Invoice_No from tbl_purchase WHERE Id='$mid'");
				   ...
				   <div class="form-group col-sm-4">
						 ...
						 <div class="col-sm-8">
							<input type="text" placeholder="Invoice No" value="<?php echo $inv_no_1; ?>" maxlength="150" id="form-field-1"  class="form-control limited" maxlength="15" name="invoice_no" required>
						</div>
						 <script>
					...
					$('.dp').on('change', function () {
                     ...
                     $("#other_charge").val(0);
						...
						<div class="form-group col-sm-4">        
                   <label for="inputName" class="col-sm-4 control-label">Supplier Date</label>
                    <div class="col-sm-8">
						<input class="form-control dp"  value="<?php echo date('d-m-Y');?>" name="supplier_date" id="supplier_date" required>
				   ...
				   <div class="form-group col-sm-4">
						 <label for="inputName" class="col-sm-4 control-label">Supplier Invoice<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-8">
							<input type="text" placeholder="Supplier Invoice No" maxlength="150" id="form-field-1"  class="form-control limited" maxlength="15" name="supplier_invoice_no" required>
						</div>
						 <script>
					$(document).ready(function () {
					$('.dp').datepicker({
				   ...
				   <div class="form-group col-sm-4">
					  ...
					  <div class="form-group col-sm-4">
						...
						<div class="form-group col-sm-4">
						  ...
						  <label for="inputName" class="col-sm-4 control-label">Units</label>
						   <div class="col-sm-8" style="margin-left: 0px;">
							<input type="text" maxlength="15" id="units" class="limited" style="width:80%;" maxlength="15" name="units">
							</div>
							</div>
						   ...
						   function addrow()
							{
								...
								if(quantity_original!='') {
								    var ori_quantity = quantity_original;
								...
								cell3.innerHTML = ori_quantity;
								cell4.innerHTML = rate;
								cell5.innerHTML = amount;
								cell6.innerHTML = cgst_1;
								cell7.innerHTML = sgst_1;
								cell8.innerHTML = 0;
								...
								$("#netamount_1").val(net_amount);
								$("#ori_quantity_1").val(ori_quantity);
								$("#unit_1").val(units);
								...
								$("#ori_quantity_2").val(ori_quantity);
								$("#unit_2").val(units);
								...
								$("#ori_quantity_3").val(ori_quantity);
								$("#unit_3").val(units);
								...
								$("#ori_quantity_4").val(ori_quantity);
								$("#unit_4").val(units);
								...
								$("#ori_quantity_5").val(ori_quantity);
								$("#unit_5").val(units);
								...
								$("#ori_quantity_6").val(ori_quantity);
								$("#unit_6").val(units);
								...
								$("#ori_quantity_7").val(ori_quantity);
								$("#unit_7").val(units);
								...
								$("#ori_quantity_8").val(ori_quantity);
								$("#unit_8").val(units);
								...
								$("#ori_quantity_9").val(ori_quantity);
								$("#unit_9").val(units);
								...
								$("#ori_quantity_10").val(ori_quantity);
								$("#unit_10").val(units);
								...
								$("#ori_quantity_11").val(ori_quantity);
								$("#unit_11").val(units);
								...
								$("#ori_quantity_12").val(ori_quantity);
								$("#unit_12").val(units);
								...
								$("#ori_quantity_13").val(ori_quantity);
								$("#unit_13").val(units);
								...
								$("#ori_quantity_14").val(ori_quantity);
								$("#unit_14").val(units);
								...
								$("#ori_quantity_15").val(ori_quantity);
								$("#unit_15").val(units);
								...
								$("#ori_quantity_16").val(ori_quantity);
								$("#unit_16").val(units);
								...
								$("#ori_quantity_17").val(ori_quantity);
								$("#unit_17").val(units);
								...
								$("#ori_quantity_18").val(ori_quantity);
								$("#unit_18").val(units);
								...
								$("#ori_quantity_19").val(ori_quantity);
								$("#unit_19").val(units);
								...
								$("#ori_quantity_20").val(ori_quantity);
								$("#unit_20").val(units);
								...
								$("#ori_quantity_21").val(ori_quantity);
								$("#unit_21").val(units);
								...
								$("#ori_quantity_22").val(ori_quantity);
								$("#unit_22").val(units);
								...
								$("#ori_quantity_23").val(ori_quantity);
								$("#unit_23").val(units);
								...
								$("#ori_quantity_24").val(ori_quantity);
								$("#unit_24").val(units);
								...
								$("#ori_quantity_25").val(ori_quantity);
								$("#unit_25").val(units);
								...
								$("#ori_quantity_26").val(ori_quantity);
								$("#unit_26").val(units);
								...
								$("#ori_quantity_27").val(ori_quantity);
								$("#unit_27").val(units);
								...
								$("#ori_quantity_28").val(ori_quantity);
								$("#unit_28").val(units);
								...
								$("#ori_quantity_29").val(ori_quantity);
								$("#unit_29").val(units);
								...
								$("#ori_quantity_30").val(ori_quantity);
								$("#unit_30").val(units);
								...
								$("#ori_quantity_31").val(ori_quantity);
								$("#unit_31").val(units);
								...
								$("#ori_quantity_32").val(ori_quantity);
								$("#unit_32").val(units);
								...
								$("#ori_quantity_33").val(ori_quantity);
								$("#unit_33").val(units);
								...
								$("#ori_quantity_34").val(ori_quantity);
								$("#unit_34").val(units);
								...
								$("#ori_quantity_35").val(ori_quantity);
								$("#unit_35").val(units);
								...
								$("#ori_quantity_36").val(ori_quantity);
								$("#unit_36").val(units);
								...
								$("#ori_quantity_37").val(ori_quantity);
								$("#unit_37").val(units);
								...
								$("#ori_quantity_38").val(ori_quantity);
								$("#unit_38").val(units);
								...
								$("#ori_quantity_39").val(ori_quantity);
								$("#unit_39").val(units);
								...
								$("#ori_quantity_40").val(ori_quantity);
								$("#unit_40").val(units);
								...
								$("#ori_quantity_41").val(ori_quantity);
								$("#unit_41").val(units);
								...
								$("#ori_quantity_42").val(ori_quantity);
								$("#unit_42").val(units);
								...
								$("#ori_quantity_43").val(ori_quantity);
								$("#unit_43").val(units);
								...
								$("#ori_quantity_44").val(ori_quantity);
								$("#unit_44").val(units);
								...
								$("#ori_quantity_45").val(ori_quantity);
								$("#unit_45").val(units);
								...
								$("#ori_quantity_46").val(ori_quantity);
								$("#unit_46").val(units);
								...
								$("#ori_quantity_47").val(ori_quantity);
								$("#unit_47").val(units);
								...
								$("#ori_quantity_48").val(ori_quantity);
								$("#unit_48").val(units);
								...
								$("#ori_quantity_49").val(ori_quantity);
								$("#unit_49").val(units);
								...
								$("#ori_quantity_50").val(ori_quantity);
								$("#unit_50").val(units);
								...
								$("#ori_quantity_51").val(ori_quantity);
								$("#unit_51").val(units);
								...
								$("#ori_quantity_52").val(ori_quantity);
								$("#unit_52").val(units);
								...
								$("#ori_quantity_53").val(ori_quantity);
								$("#unit_53").val(units);
								...
								$("#ori_quantity_54").val(ori_quantity);
								$("#unit_54").val(units);
								...
								$("#ori_quantity_55").val(ori_quantity);
								$("#unit_55").val(units);
								...
								$("#ori_quantity_56").val(ori_quantity);
								$("#unit_56").val(units);
								...
								$("#ori_quantity_57").val(ori_quantity);
								$("#unit_57").val(units);
								...
								$("#ori_quantity_58").val(ori_quantity);
								$("#unit_58").val(units);
								...
								$("#ori_quantity_59").val(ori_quantity);
								$("#unit_59").val(units);
								...
								$("#ori_quantity_60").val(ori_quantity);
								$("#unit_60").val(units);
								...
								$("#ori_quantity_61").val(ori_quantity);
								$("#unit_61").val(units);
								...
								$("#ori_quantity_62").val(ori_quantity);
								$("#unit_62").val(units);
								...
								$("#ori_quantity_63").val(ori_quantity);
								$("#unit_63").val(units);
								...
								$("#ori_quantity_64").val(ori_quantity);
								$("#unit_64").val(units);
								...
								$("#ori_quantity_65").val(ori_quantity);
								$("#unit_65").val(units);
								...
								$("#ori_quantity_66").val(ori_quantity);
								$("#unit_66").val(units);
								...
								$("#ori_quantity_67").val(ori_quantity);
								$("#unit_67").val(units);
								...
								$("#ori_quantity_68").val(ori_quantity);
								$("#unit_68").val(units);
								...
								$("#ori_quantity_69").val(ori_quantity);
								$("#unit_69").val(units);
								...
								$("#ori_quantity_70").val(ori_quantity);
								$("#unit_70").val(units);
								...
								var net_total_value_1 = (parseFloat(total_value) - parseFloat(discount_1) + parseFloat(other_charge)).toFixed(2);
		...
		function get_discount(val)
			 {
				...
				var dis_net_total =  (parseFloat(net_total) - parseFloat(val_1)).toFixed(2);
...
function deleteRow(r) {
  ...
  document.getElementById("mytable").deleteRow(i);
	...
	<input type="hidden" name="unit_s[]" id="unit_1">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_1">
	</div>
	...
	<input type="hidden" name="unit_s[]" id="unit_2">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_2">
	</div>
	...
	<input type="hidden" name="unit_s[]" id="unit_3">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_3">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_4">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_4">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_5">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_5">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_6">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_6">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_7">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_7">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_8">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_8">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_9">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_9">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_10">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_10">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_11">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_11">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_12">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_12">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_13">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_13">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_14">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_14">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_15">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_15">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_16">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_16">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_17">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_17">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_18">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_18">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_19">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_19">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_20">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_20">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_21">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_21">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_22">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_22">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_23">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_23">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_24">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_24">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_25">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_25">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_26">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_26">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_27">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_27">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_28">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_28">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_29">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_29">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_30">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_30">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_31">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_31">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_32">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_32">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_33">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_33">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_34">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_34">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_35">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_35">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_36">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_36">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_37">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_37">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_38">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_38">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_39">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_39">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_40">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_40">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_41">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_41">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_42">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_42">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_43">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_43">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_44">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_44">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_45">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_45">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_46">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_46">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_47">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_47">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_48">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_48">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_49">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_49">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_50">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_50">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_51">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_51">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_52">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_52">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_53">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_53">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_54">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_54">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_55">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_55">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_56">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_56">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_57">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_57">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_58">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_58">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_59">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_59">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_60">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_60">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_61">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_61">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_62">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_62">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_63">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_63">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_64">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_64">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_65">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_65">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_66">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_66">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_67">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_67">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_68">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_68">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_69">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_69">
	</div>
	<div class="col-sm-12">     
	...
	<input type="hidden" name="unit_s[]" id="unit_70">
	<input type="hidden" name="ori_quantity_1[]" id="ori_quantity_70">
	</div>
	</div>
	</div>
						 <div class="col-sm-12">                        
