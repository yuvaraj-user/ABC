...
if (isset($_REQUEST['submit'])) {
    ...
    $insert_details = mysqli_query($con, "UPDATE `tbl_stock_group` SET `Name`='$Name',`Parent`='$parent',`Gst_Rate`='$Gst_Rate',`App_Date`='$App_Date',`Igst`='$Igst',`Igst`='$Igst', `Sgst`='$Sgst',`Gst`='$Gst',`Hsn_Code`='$Hsn_Code', `Remarks`='$Remarks' WHERE Id='$id'");

    if ($insert_details) {
        echo '<script type="text/javascript">
					window.location.replace("stock_group_view.php?step=edit");
					</script>';
    } else {
        echo '<script type="text/javascript">
        ...
        <div class="content-wrapper">
            <div class="row panel panel-primary">
                ...
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8"><b>Edit Stock Group</b></div>
                        <div class="col-lg-4 col-md-4 text-right">
                            <div class="btn-group text-center">
                                <a href="stock_group_view.php" class="btn btn-success"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;Stock Group View</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <?php
            $id = $_REQUEST['Id'];
            $qury = "SELECT * FROM `tbl_stock_group` WHERE Id='$id'";
...
<div class="form-group col-sm-12">
                        ...
                        <div class="col-md-12">
                            <section class="content">
								...
								<input class="form-control dp" value="<?php echo  $fetch['App_Date']; ?>" placeholder="Pick the Date  dd-mm-yyyy" name="Gst_App_Date" id="acctopendate">
						...
						<script>
								$(document).ready(function() {
									...
									$("#other_charge").val(0);
                                                            ...
                                                            <td><input type="text" id="form-field-1" class="form-control limited" value="<?php echo $fetch['Gst']; ?>" name="Gst_Rate" style="width:58%;"></td>
                                                            <td><input type="text" id="form-field-1" class="form-control limited" value="<?php echo $fetch['Sgst']; ?>" name="Igst" style="width:58%;"></td>
                                                            <td><input type="text" id="form-field-1" class="form-control limited" value="<?php echo $fetch['Igst']; ?>" name="Gst" style="width:58%;"></td>
                                                            <td><input type="text" id="form-field-1" class="form-control limited" value="<?php echo $fetch['Gst_Rate']; ?>" name="Sgst" style="width:58%;"></td>
