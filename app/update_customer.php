...
if(isset($_REQUEST['submit']))
{
	...
	$updatedby=$_SESSION['User'];
		...
		$insert_details = mysqli_query($con,"UPDATE tbl_customer SET Name='$Name',Address_Line1='$Address_Line1',Address_Line2='$Address_Line2',Address_Line3='$Address_Line3',Address_Line4='$Address_Line4',State='$State',
...
<?php
            $id = $_REQUEST['id'];
            $qury="SELECT * FROM `tbl_customer` WHERE Id='$id' and Status='Active'";
