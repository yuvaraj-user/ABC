...
if(isset($_REQUEST['submit']))
{
	...
	$createdby=$_SESSION['usersessionid'];
		...
		$insert_details = mysqli_query($con,"UPDATE `tbl_tax` SET `Name`='$name', `Hsn`='$hsn', `Tax_Price`='$tax_rate', `Igst`='$igst', `SgSt`='$sgst', `Cgst`='$cgst', `Updated_On`='$createdon', `Updated_By`='$createdby' WHERE Id='$id'");
			...
			<div class="col-lg-4 col-md-4 text-right">
                ...
                <div class="panel-body"> 
				  ...
				  <?php
				    ...
				    $id = $_REQUEST['id'];
					$qury="SELECT * FROM `tbl_tax` WHERE Id='$id' and Status='Active'";
				  ...
				  ?>
					  ...
					  <div class="form-group col-sm-12">
						 ...
						 <div class="col-sm-4">
							<input type="text" placeholder="Tax Rate" value="<?php echo $fetch['Tax_Price']; ?>" maxlength="150" id="form-field-1"  class="form-control limited" maxlength="15" name="tax_rate" required>
						</div>
