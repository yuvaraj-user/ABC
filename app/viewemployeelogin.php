...
<?php 
    ...
    <strong>Success!</strong> Employee is Added Successfully.
  </div>
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Employee</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<a href="addemployeelogin.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Login</a>
				</div>
		</div>
	</div>
            ...
            <div class="col-xs-12">
              <div class="box">
				...
				<table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
		<?php 
				$qury_cus="select c.*,e.* from tbl_users c left left join tbl_employee e on c.Emp_tbl_Id=e.Id where c.Status='Active'";
					...
					?>
                        <tr>
			<td><?php echo $i; ?></td>
            <td><?php if($fetch['Name']== ''){ Echo "Admin"; }else{ echo $fetch['Name']; }; ?></td> 
