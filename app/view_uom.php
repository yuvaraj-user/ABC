...
$selectlevel = mysqli_query($con, "select * from add_uom where Id='$sessionuserid'");
        ...
        <div class="content-wrapper">
            <div class="row panel panel-primary">
                ...
                ?>
                    <div class="alert alert_msg alert-success alert-dismissable">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                        <strong>Success!</strong> Uom was Updated Successfully.
                    </div>
                ...
                <div class="panel-heading lead ">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-right">
                            <a href="add_uom.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Uom</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fetch['Decimal']; ?></td>
                                                    <td><?php echo $fetch['Remarks']; ?></td>
                                                    <td>

                                                        <button type="button" onclick="window.location.href='edit_uom.php?id=<?php echo $fetch['id']; ?>'" class="btn btn-primary">Edit&nbsp;</button>

                                                        <button type="button" class="btn btn-danger" onclick="window.location.href='delete_uom.php?do=delete&id=<?php echo $fetch['id']; ?>'"><a style=" text-decoration: none; color:#FFF">Delete&nbsp;</a></button>
