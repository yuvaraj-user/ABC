...
if(isset($_REQUEST['remark']))
{
	...
	$createdby=$_SESSION['usersessionid'];	
								$query_update_enable="update `tbl_supplier` set Remark='$remarks',Status='Inactive',Updated_By='$createdby',Updated_On='$createdon' WHERE Id='$id'";
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("view_supplier.php?step=delete");
					</script>';										
									}
									else
									{ 
      ...
      <div class="col-lg-8 col-md-8">Add Remark Details</div>        
        <div class="col-lg-4 col-md-4 text-right">
          <div class="btn-group text-center">
            ...
            <a href="view_supplier.php" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Supplier</a>
          </div>
        </div>
    </div>
  </div>
