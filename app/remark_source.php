...
if(isset($_REQUEST['remark']))
{
								...
								$query_update_enable="update `tbl_source` set Remark='$remarks',Status='Deleted' WHERE Id='$id'";
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("view_source.php?step=delete");
					</script>';										
									}
									else
									{ 
