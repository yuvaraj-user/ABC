...
$selectlevel = mysqli_query($con, "select * from stock_item where Id='$sessionuserid'");
        ...
        <div class="content-wrapper">
            <div class="row panel panel-primary">
                ...
                <div class="panel-heading lead ">
                    <div class="row">
                        <div class="col-lg-8 col-md-8"><label>View Stock Items</label></div>
                        <div class="col-lg-4 col-md-4 text-right">
                            <a href="add_stock_item.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Stock Items</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $qury = "select * FROM tbl_stock_item WHERE Status='Active'";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $fetch['Gst_App_Date']; ?></td>
                                                    <td><?php echo $fetch['Igst']; ?></td>
                                                    <td><?php echo $fetch['Cgst']; ?></td>
                                                    <td><?php echo $fetch['Sgst']; ?></td>
                                                    <td><?php echo $fetch['Hsn_Code']; ?></td>
                                                    <td><?php echo $fetch['Cost_App_Date']; ?></td>
                                                    <td><?php echo $fetch['Rate']; ?></td>
                                                    <td><?php echo $fetch['Remarks']; ?></td>
                                                    <td>

                                                        <button type="button" onclick="window.location.href='edit_stock_item.php?Id=<?php echo $fetch['Id']; ?>'" class="btn btn-primary"> <i class="fa fa-edit" aria-hidden="true"></i> </button>

                                                        <button type="button" class="btn btn-danger" onclick="window.location.href='delete_stock_item.php?do=delete&Id=<?php echo $fetch['Id']; ?>'"><a style=" text-decoration: none; color:#FFF"> <i class="fa fa-trash" aria-hidden="true"></i> </a></button>
