...
if(isset($_REQUEST['submit']))
{
	...
	$order_no_1 = $_REQUEST['order_no_1'];
	$order_no_2 = $_REQUEST['order_no_2'];
	...
	$unit_s_6 = $_REQUEST['unit_s_6'];
	$ori_quantity_1_6 = $_REQUEST['ori_quantity_1_6'];
	...
	for($i=0;$i<sizeof($product_s_6);$i++){
		...
		$unit_sd_6 = $unit_s_6[$i];
		$ori_quantity_1d_6 = $ori_quantity_1_6[$i];
		if($netamount_sd_6 !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase`(`Supplier_Name`, `Date`, `Invoice_No`,`Grn_No`, `Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Supplier_Invoice_No`,`Supplier_Date`,`Unit`,`Original_Quantity`,Purchase_Order_No) VALUES ('$supplier','$acctdate','$invoice_no','$grn_no','$product_sd_6','$quantity_sd_6','$rate_sd_6','$amount_sd_6','$cgst_sd_6','$sgst_sd','0','$netamount_sd_6','$total_6','$discount','$other_charge','$net_total_6','$createdon','$createdby','$status','$supplier_invoice_no','$supplier_date','$unit_sd','$ori_quantity_1d','$order_no')");
	}
	} 
	...
	$netamount_s_1 = array();
	$unit_s_1 = array();
	$ori_quantity_1_1 = array();
	
	
	$product_s_1 = $_REQUEST['product_s_1'];
	$quantity_s_1 = $_REQUEST['quantity_s_1'];
	$rate_s_1 = $_REQUEST['rate_s_1'];
	$amount_s_1 = $_REQUEST['amount_s_1'];
	$cgst_s_1 = $_REQUEST['cgst_s_1'];
	$sgst_s_1 = $_REQUEST['sgst_s_1'];
	$igst_s_1 = $_REQUEST['igst_s_1'];
	$netamount_s_1 = $_REQUEST['netamount_s_1'];
	$unit_s_1 = $_REQUEST['unit_s_1'];
	$ori_quantity_1_1 = $_REQUEST['ori_quantity_1_1'];
	
	for($i=0;$i<sizeof($product_s_1);$i++){
		
		$product_sd_1 = $product_s_1[$i];
		$quantity_sd_1 = $quantity_s_1[$i];
		$rate_sd_1 = $rate_s_1[$i];
		$amount_sd_1 = $amount_s_1[$i];
		$cgst_sd_1 = $cgst_s_1[$i];
		$sgst_sd_1 = $sgst_s_1[$i];
		$igst_sd_1 = $igst_s_1[$i];
		$netamount_sd_1 = $netamount_s_1[$i];
		$unit_sd_1 = $unit_s_1[$i];
		$ori_quantity_1d_1 = $ori_quantity_1_1[$i];
		if($netamount_sd_1 !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase`(`Supplier_Name`, `Date`, `Invoice_No`,`Grn_No`, `Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Supplier_Invoice_No`,`Supplier_Date`,`Unit`,`Original_Quantity`,Purchase_Order_No) VALUES ('$supplier','$acctdate','$invoice_no','$grn_no','$product_sd_1','$quantity_sd_1','$rate_sd_1','$amount_sd_1','$cgst_sd_1','$sgst_sd_1','0','$netamount_sd_1','$total_1','$discount_1','$other_charge','$net_total_1','$createdon','$createdby','$status','$supplier_invoice_no','$supplier_date','$unit_sd','$ori_quantity_1d_1','$order_no_1')");
	}
	}
	...
	$netamount_s_2 = array();
	$unit_s_2 = array();
	$ori_quantity_1_2 = array();
	
	
	$product_s_2 = $_REQUEST['product_s_2'];
	$quantity_s_2 = $_REQUEST['quantity_s_2'];
	$rate_s_2 = $_REQUEST['rate_s_2'];
	$amount_s_2 = $_REQUEST['amount_s_2'];
	$cgst_s_2 = $_REQUEST['cgst_s_2'];
	$sgst_s_2 = $_REQUEST['sgst_s_2'];
	$igst_s_2 = $_REQUEST['igst_s_2'];
	$netamount_s_2 = $_REQUEST['netamount_s_2'];
	$unit_s_2 = $_REQUEST['unit_s_2'];
	$ori_quantity_1_2 = $_REQUEST['ori_quantity_1_2'];
	
	for($i=0;$i<sizeof($product_s_2);$i++){
		
		$product_sd_2 = $product_s_2[$i];
		$quantity_sd_2 = $quantity_s_2[$i];
		$rate_sd_2 = $rate_s_2[$i];
		$amount_sd_2 = $amount_s_2[$i];
		$cgst_sd_2 = $cgst_s_2[$i];
		$sgst_sd_2 = $sgst_s_2[$i];
		$igst_sd_2 = $igst_s_2[$i];
		$netamount_sd_2 = $netamount_s_2[$i];
		$unit_sd_2 = $unit_s_2[$i];
		$ori_quantity_1d_2 = $ori_quantity_1_2[$i];
		if($netamount_sd_2 !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase`(`Supplier_Name`, `Date`, `Invoice_No`,`Grn_No`, `Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Supplier_Invoice_No`,`Supplier_Date`,`Unit`,`Original_Quantity`,Purchase_Order_No) VALUES ('$supplier','$acctdate','$invoice_no','$grn_no','$product_sd_2','$quantity_sd_2','$rate_sd_2','$amount_sd_2','$cgst_sd_2','$sgst_sd_2','0','$netamount_sd_2','$total_2','$discount_2','$other_charge','$net_total_2','$createdon','$createdby','$status','$supplier_invoice_no','$supplier_date','$unit_sd','$ori_quantity_1d_2','$order_no_2')");
	}
	}
...
<?php
   ...
   $order = $_REQUEST['id'];
$qury_opn="select * from tbl_purchase_order where Status='Active' AND Order_No='$order'";
...
?>
				  ...
				  <div class="row">
	                 <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8" style="margin-left: 0px;">						
						 <select class="form-control selectpicker" name="supplier" id="supplier" onchange="get_grn_details(this.value);" data-live-search="true" required readonly>
                   ...
                   <label for="inputName" class="col-sm-4 control-label">Supplier Date</label>
                    <div class="col-sm-8">
						...
						<div class="form-group col-sm-4">
						 ...
						 <div class="col-sm-8">
							<input type="text" maxlength="150" id="order_no" value="<?php echo $Order_No; ?>" class="form-control limited" maxlength="15" name="order_no" required readonly>
						</div>
						 <script>
					$(document).ready(function () {
					$('.dp').datepicker({
		...
		<table id="example1" class="table table-responsive table-bordered table-striped">
            ...
            <th style="width: 100px;">Net Amount</th>
						...
						<tbody>
						<?php 
						  $qury="select p.*,t.Name as prod_name,t.Id as tid,t.Sgst as prod_sgst,t.Cgst as prod_cgst from tbl_purchase_order p left join tbl_product t on t.Id=p.Product_Id where p.Order_No='$Order_No' AND p.Status='Active'";
					$qury_exe=mysqli_query($con,$qury);
						...
						while($fetch=mysqli_fetch_array($qury_exe))
							...
							<tr>
								...
								<td><input type="text" id="product_6_1" value="<?php echo $product_Name; ?>" readonly><input type="hidden" name="product_s_6[]" id="product_5" value="<?php echo $tid; ?>" readonly></td>
								<td><input type="text" name="quantity_s_6[]" onchange="addrow1(this.value);" id="quantity_6_1" value="<?php echo $Quantity; ?>" style="width: 100px;"></td>
								...
								<td style="width: 100px;"><?php echo $i;?></td>
								<td><input type="text" id="product_6_2" value="<?php echo $product_Name; ?>" readonly><input type="hidden" name="product_s_6[]" id="product_5" value="<?php echo $tid; ?>" ></td>
								<td style="width: 100px;"><input type="text" name="quantity_s_6[]" id="quantity_6_2" onchange="addrow2(this.value);" value="<?php echo $Quantity; ?>" style="width: 100px;"></td>
								...
								<td style="width: 100px;"><?php echo $i;?></td>
								<td><input type="text" value="<?php echo $product_Name; ?>" readonly><input type="hidden" name="product_s_6[]" id="product_6_3" value="<?php echo $tid; ?>"></td>
								<td ><input type="text" name="quantity_s_6[]" style="width: 100px;" onchange="addrow3(this.value);" id="quantity_6_3" value="<?php echo $Quantity; ?>" style="width: 100px;"></td>
					...
					<tr>
							...
							<tr>
								...
								<td><input type="text" name="discount_s_6[]" id="discount_s" value="<?php echo $Discount ?>" readonly></td>
	...
	<div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8" style="margin-left: 0px;">						
						 <select class="form-control selectpicker" name="order_no_1" id="grn" onchange="get_purchase_order(this.value);" data-live-search="true">
