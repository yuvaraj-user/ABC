...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Update Supplier</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="view_upm.php" class="btn btn-success"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;View Supplier</a>
				</div>
			</div>
	</div>
</div>
                    ...
                    <form class="form-horizontal" name="addaccount_details" action="" method="post" enctype="multipart/form-data" >
					  ...
					  <div class="form-group col-sm-12">
						...
						<div class="form-group col-sm-12">
						 ...
						 <div class="col-sm-4" name="Gst_Type" >
