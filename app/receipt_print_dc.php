...
<div class="row panel panel-primary"> 
        ...
        <section class="content">
		  ...
		  <?php  
				    ...
				    $qurydelct_total="SELECT Date,c.Name as cus_name FROM `tbl_dc` r left join tbl_customer c on r.Customer_Id=c.Id WHERE r.Invoice_No='$inv_no' AND r.Status='Active'";
	...
	<tr>
		...
		if ($valpend<> ' ') {
		 ...
		 next($overal_paid);
		            ...
		            $qurydelct_gst="SELECT SUM(Cgst) as cgst_amt,SUM(Cgst) as sgst FROM `tbl_dc` WHERE Invoice_No='$inv_no' AND Status='Active'";
					...
					$qurydelct_total="SELECT Net_Total FROM `tbl_dc` WHERE Invoice_No='$inv_no' AND Status='Active'";
					$qury_det_total=mysqli_query($con,$qurydelct_total);
					$fetch_det_total=mysqli_fetch_array($qury_det_total);
