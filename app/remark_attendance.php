...
if(isset($_REQUEST['remark']))
{
								...
								$query_update_enable="update `tbl_attendance` set Remarks='$remarks',Status='Deleted' WHERE Id='$id'";
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("view_employee_attendance.php?step=delete");
					</script>';										
									}
									else
									{ 
      ...
      <div class="col-lg-8 col-md-8">Add Remark Details</div>        
        <div class="col-lg-4 col-md-4 text-right">
          <div class="btn-group text-center">
            <a href="view_employee_attendance.php" class="btn btn-info"><i class="fa fa-eye"></i>&nbsp;&nbsp;&nbsp;View Attendance Details</a>
          </div>
        </div>
    </div>
  </div>
