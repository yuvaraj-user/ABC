...
if(isset($_REQUEST['submit']))
{
	...
	for($i=0;$i<sizeof($product_s);$i++){
		...
		if($netamount_sd !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase_return`(`Supplier_Id`, `Date`,  `Invoice_No`,`Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Purchase_Invoice_No`) VALUES ('$supplier','$acctdate','$Invoice_No','$product_sd','$quantity_sd','$rate_sd','$amount_sd','$cgst_sd','$sgst_sd','$igst_sd','$netamount_sd','$total','$discount','$other_charge','$net_total','$createdon','$createdby','$status','$purchase_invoice_no')");
	}
	}
	if($insert_details){
			 echo '<script type="text/javascript">
					window.location.replace("report_purchase_return.php?step=suces");
					</script>';	
		 ...
		 echo '<script type="text/javascript">
					window.location.replace("report_purchase_return.php?step=fail");
					</script>';
	}
}
?>
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Add Purchase Return</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="report_purchase_return.php" class="btn btn-success"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;View Purchase Return</a>
				</div>
			</div>
	</div>
</div>
				...
				<div class="form-group col-sm-4">        
				   ...
				   <div class="form-group col-sm-4">
						 <label for="inputName" class="col-sm-4 control-label">Debit Note No<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-8">
					...
					$('.dp').on('change', function () {
                     ...
                     $("#other_charge").val(0);
						...
						<div class="form-group col-sm-4">
						 <label for="inputName" class="col-sm-4 control-label">Purchase Invoice No<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-8">
							<input type="text" placeholder="Purchase Invoice No" maxlength="150" id="form-field-1"  class="form-control limited" maxlength="15" name="purchase_invoice_no" required>
						</div>
						</div>
						</div>
