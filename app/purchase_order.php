...
if(isset($_REQUEST['submit']))
{
	...
	for($i=0;$i<sizeof($product_s);$i++){
		...
		if($netamount_sd !=0) {
		$insert_details = mysqli_query($con,"INSERT INTO `tbl_purchase_order`(`Supplier_Name`, `Date`, `Order_No`,`Grn_No`, `Product_Id`, `Quantity`, `Rate`, `Amount`, `Cgst`, `Sgst`, `Igst`, `Net_Amount`, `Total`, `Discount`, `Other_Charges`, `Net_Total`, `Created_On`, `Created_By`, `Status`,`Supplier_Invoice_No`,`Supplier_Date`,`Unit`,`Original_Quantity`) VALUES ('$supplier','$acctdate','$invoice_no','$grn_no','$product_sd','$quantity_sd','$rate_sd','$amount_sd','$cgst_sd','$sgst_sd','0','$netamount_sd','$total','$discount','$other_charge','$net_total','$createdon','$createdby','$status','$supplier_invoice_no','$supplier_date','$unit_sd','$ori_quantity_1d')");
	}
	}
	if($insert_details){
...
<div class="panel-heading lead ">
	<div class="row">
		<div class="col-lg-8 col-md-8"><b>Purchase Order</b></div>				
			<div class="col-lg-4 col-md-4 text-right">
				<div class="btn-group text-center">
					<a href="purchase_order_outstanding.php" class="btn btn-success"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;View Purchase Order</a>
				</div>
			</div>
	</div>
</div>
                   ...
                   <label for="inputName" class="col-sm-4 control-label">Date</label>
					...
					$('.dp').on('change', function () {
                     ...
                     $("#other_charge").val(0);
					  ...
					  <div class="form-group col-sm-4">
						 <label for="inputName" class="col-sm-4 control-label">Purchase Order No<font color="red">&nbsp;*&nbsp;</font></label>
						 <div class="col-sm-8">
