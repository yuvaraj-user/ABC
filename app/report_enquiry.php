...
<div class="row panel panel-primary"> 
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Enquiry Report</div>				
		...
		<div class="col-lg-12 col-sm-12"> 
			...
			<label for="inputName" class="col-sm-2 control-label" >Customer</label>
				<div class="form-group col-sm-4" style="margin-left: 0px;">						
					...
					<?php 
					$select_GrpQryss=mysqli_query($con,"select * from tbl_customer WHERE Status='Active'");
					while($fetch_GrpQrys=mysqli_fetch_array($select_GrpQryss))
					{
						$Name=$fetch_GrpQrys['Name'];
						$Id=$fetch_GrpQrys['Id'];
						?>
