...
if (isset($_REQUEST['submit'])) {
    ...
    $objPHPExcel->getActiveSheet()->getStyle("C1:N1")->getFont()->setBold( true );
                                ...
                                <div class="box-body">
                                    <form action="detailed_attendance_report.php" method="POST">
                                            ...
                                            <div class="col-sm-10">
                                                <select id="attendance" name="attendance_type" class="form-control selectpicker" required>
                                                    ...
                                                    while ($fetch_attend_array = mysqli_fetch_array($attendance_details)) {
                                                        $f_date             = strtotime($fetch_attend_array['From_Date']);
                                                        $t_date             = strtotime($fetch_attend_array['To_Date']);
                                                        $diff_days          = round(($t_date - $f_date) / (60 * 60 * 24));
                                                        if($diff_days == 6) {
                                                        $fetch_attend_id = $fetch_attend_arrsay['Id'];
                                        ...
                                        <div class="col-sm-2 form-group">
                                            <button class="btn btn-info" type="submit" name="submit"><i class="fa fa-download"></i>&nbsp;&nbsp;&nbsp;Get Report</button>
                                        </div>
                                        <br>
                                        <br>
                                        <br>
