...
if(isset($_REQUEST['submit']))	{
	     ...
	     $family_no = array();
	 $family_no = $_REQUEST['id']; 
	    for($i=0;$i<sizeof($family_no);$i++){
		
		 $readid 	= $family_no[$i];
		 
		 $query_update_enable = "update `tbl_order_creation` set is_factory_view='1' WHERE id='$readid'"; 
...
<?php 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Priority List Udpate</div>				
...
<?php
									             ...
									             $query_getall2="SELECT * FROM `tbl_order_creation` WHERE Status='Active' and is_factory_view='1'";
...
<form class="form-horizontal" name="addcustomer_details"  id="addauctionform" method="post" enctype="multipart/form-data" >
					...
					?>
							<tr>
								...
								<td><?php echo $fetch['machine_code'];?></td>
								<td><?php echo $fetch['pdn_points'];?></td>
								<td><?php echo $fetch['target_date'];?></td>
								<td><button type="button"  class="btn btn-success" onclick="window.location.href='machine_status_update.php?id=<?php echo $fetch['id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Status Update&nbsp;</a></button></td>
