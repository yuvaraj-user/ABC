...
<html>
  <head>
    ...
    <title>Chit | Designation remark</title>
...
if(isset($_REQUEST['remark']))
{
								...
								$remarks=$_REQUEST['remarks'];
								 $query_update_enable="UPDATE `tbl_designation` SET Remark='$remarks',Status='Deleted' WHERE Id='$id'";
									$passquery_update_enable=mysqli_query($con,$query_update_enable);
									if($passquery_update_enable)
									{
echo '<script type="text/javascript">
					window.location.replace("viewdesignation.php?step=delete");
					</script>';										
									}
									else
									{ 
