...
if(isset($_REQUEST['update'])){
	...
	$updatedby=$_SESSION['User'];
		...
		$qry_update=mysqli_query($con,"UPDATE `tbl_designation` SET `Name`='$gpname',`Remark`='$z_remark',`Updated_On`='$updatedon',`Updated_By`='$updatedby' WHERE Status='Active' AND Id='$gid'");
		if($qry_update){
			 echo '<script type="text/javascript">
					window.location.replace("viewdesignation.php?step=update");
					</script>';	
...
<div class="row panel panel-primary"> 
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8">Edit Designation Details</div>				
	...
	<div class="panel-body"> 
					...
					<?php 
			        $gid=$_REQUEST['id'];
				    $qury="SELECT * FROM `tbl_designation` WHERE Id='$gid' and Status='Active'";
					...
					<!--<input type="text" name="edit_id" class="form-control" value="<?php echo $gid; ?>" id="edit_id">-->
                      <div class="form-group">
						...
						<div class="col-sm-4">	
							 <input type="text" class=" form-control"  value="<?php echo $gpnum; ?>"  name="e_code"  id="e_code" placeholder="Zone Code" required readonly>
						</div>
                      </div> 
						<div class="form-group">
