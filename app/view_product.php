...
<?php 
    ...
    <strong>Success!</strong> Machine is Added Successfully.
  </div>
	...
	{ ?>
		<div class="alert alert_msg alert-danger alert-dismissable">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
    <strong>Success!</strong> Machine is Removed Successfully.
	</div>
	<?php } 
	...
	<div class="panel-heading lead ">
		<div class="row">
			<div class="col-lg-8 col-md-8"><label>View Machine</label></div>				
				<div class="col-lg-4 col-md-4 text-right">
						<!-- a href="excel_upload.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Excel Upload</a -->
							<a href="add_product.php" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Machine</a>
				</div>
		</div>
	</div>
          ...
          <div class="row">
              ...
              <div class="box">
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
					<?php 
				    $qury="select * from tbl_product where Status='Active'";
			...
			<td><?php echo $fetch['Code']; ?></td>
		     <td> 
				...
				<button type="button" onclick="window.location.href='edit_product.php?id=<?php echo $fetch['Id']; ?>'" class="btn btn-primary">Edit&nbsp;</button>
				
					<button type="button"  class="btn btn-danger" onclick="window.location.href='delete_product.php?do=delete&id=<?php echo $fetch['Id']; ?>'"><a style=" text-decoration: none; color:#FFF" >Delete&nbsp;</a></button>
